...
#for create down/n upstreamdata entry_id_new must be created from entry.id and used on the same time to have correct entry.timestamp from datetime
...
#for entrydata request by time or weekday should be better?
